                ...
                {profileDropdownOpen && (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="w-full text-left px-3 py-2 rounded-xl hover:bg-white/10 text-slate-200 hover:text-white flex items-center gap-2 transition"
                    >
                      <span>🔑</span> Manage AI & API Keys
                    </button>
